  ...
  return (
    <div className="w-full h-full bg-zinc-950 text-white p-12 flex flex-col">
      ...
      <div className="flex items-end justify-between mb-8 border-b border-zinc-800 pb-6">
        ...
        <div className="text-6xl font-black text-zinc-800">04.</div>
      </div>
      ...
      <div className="flex-1 grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
        ...
        <div className="md:col-span-4 h-full flex flex-col justify-center gap-6">
          <div className="bg-zinc-900 border border-zinc-800 p-8 rounded-3xl relative overflow-hidden">
            <div className="absolute top-0 right-0 p-32 bg-blue-900/20 rounded-full blur-3xl -mr-16 -mt-16"></div>
            ...
            <div className="mt-8 flex justify-end">
              <HelpCircle size={64} className="text-zinc-800" />
            </div>
          </div>
        </div>
        ...
        <div className="md:col-span-8 flex flex-col gap-6">
          {problems.map((item, index) => (
            <motion.div
              ...
              className="group bg-zinc-900/50 hover:bg-zinc-900 border border-zinc-800 hover:border-zinc-700 p-6 rounded-2xl transition-all duration-300 flex items-center gap-6"
            >
              {/* Number & Icon */}
              <div className="w-16 h-16 bg-zinc-950 rounded-xl border border-zinc-800 flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform">
                {item.icon}
              </div>
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-2">
                  <span className="text-xs font-mono text-zinc-500 border border-zinc-800 px-2 py-0.5 rounded-full">
                    RQ-0{item.id}
                  </span>
                ...
                <p className="text-xl md:text-2xl font-medium text-zinc-200 leading-snug">
                  {item.question}
                </p>
              </div>
            </motion.div>
