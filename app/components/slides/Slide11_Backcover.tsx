    ...
    <div className="w-full h-full bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-white p-12 flex flex-col justify-between">
      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center gap-8">
        <motion.div
          ...
          className="w-24 h-24 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-full flex items-center justify-center mb-4"
        >
          <ThumbsUp size={48} className="text-zinc-800 dark:text-zinc-200" />
        </motion.div>
        ...
        <motion.div
          ...
          className="mt-12 p-6 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl flex items-center gap-4"
        >
      ...
      <div className="flex justify-between items-end border-t border-zinc-200 dark:border-zinc-800 pt-6">
        <div className="text-9xl font-bold text-zinc-200 dark:text-zinc-900 leading-none select-none -mb-4">
          11
        </div>
