  ...
  return (
    <div className="w-full h-full bg-zinc-950 text-white p-12 flex flex-col">
      ...
      <div className="flex items-end justify-between mb-12 border-b border-zinc-800 pb-6">
        ...
        <div className="text-6xl font-black text-zinc-800">07.</div>
      </div>
        ...
        {scopes.map((item, index) => (
          <motion.div
            ...
            className={`p-8 rounded-3xl border ${
              item.isNegative
                ? "bg-zinc-900/30 border-zinc-800/50 opacity-60 hover:opacity-100 transition-opacity"
                : "bg-zinc-900 border-zinc-800 hover:bg-zinc-800/80 transition-colors"
          ...
          >
            <div>
              <div className="flex justify-between items-start mb-6">
                ...
                {item.isNegative && (
                  <span className="px-3 py-1 bg-zinc-800 rounded-full text-[10px] uppercase tracking-widest text-zinc-400">
                    Out of Scope
                  </span>
                )}
              </div>
              ...
              <h3
                className={`text-2xl font-bold mb-4 ${
                  item.isNegative ? "text-zinc-400" : "text-zinc-100"
                }`}
              >
                {item.title}
              </h3>
